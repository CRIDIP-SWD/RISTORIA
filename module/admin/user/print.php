...
?>
    <page>
        ...
        <table style="width:">
            <tr>
                <td>
                    <strong><?php echo $user['nom_user']; ?> <?php echo $user['prenom_user']; ?></strong><br>
                    <strong>Téléphone:</strong> <?php echo $user['tel_user']; ?><br>
                    <strong>Email:</strong> <?php echo $user['login']; ?>
                </td>
            </tr>
