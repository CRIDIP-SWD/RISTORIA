...
define("SUBTITLE_PAGE", "ETAT - UTILISATEUR");
//Breadcumb
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-title">
                                    <h2>Choisissez un état ...</h2>
                                </div>
                                <a href="user.php" class="btn btn-block btn-info"><i class="fi fi-pdf"></i> Impression du listing des utilisateurs</a>
                            </div>
                        </div>
                    </div>
