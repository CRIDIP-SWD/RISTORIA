...
if(isset($_POST['add-commande-control']) && $_POST['add-commande-control'] == 'Valider')
{
    ...
    $sql_add_commande = mysql_query("INSERT INTO `commande`(`idcommande`, `num_commande`, `date_commande`, `iduser`, `montant_total`)
                        VALUES (NULL,'$num_commande','','$iduser','0')")or die(mysql_error());
